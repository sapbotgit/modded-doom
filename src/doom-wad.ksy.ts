...
// The above isn't completely true... I've hacked it a bit to work in an esm context
import KaitaiStream from 'kaitai-struct/KaitaiStream';

export default function DoomWad(_io, _parent, _root) {
  this._io = _io;
...
var Seg = DoomWad.Seg = (function() {
  function Seg(_io, _parent, _root) {
    this._io = _io;
    this._parent = _parent;
    this._root = _root || this;
  ...
  Seg.prototype._read = function() {
    this.vertexStart = this._io.readS2le();
    this.vertexEnd = this._io.readS2le();
    this.angle = this._io.readS2le();
    this.linedef = this._io.readS2le();
    this.direction = this._io.readS2le();
    this.offset = this._io.readS2le();
  }
...
var Bounds = DoomWad.Bounds = (function() {
...
var Nodes = DoomWad.Nodes = (function() {
  ...
  Nodes.prototype._read = function() {
    ...
    var i = 0;
    while (!this._io.isEof()) {
      this.entries.push(new Node(this._io, this, this._root));
      i++;
    }
  }
...
var Ssectors = DoomWad.Ssectors = (function() {
  function Ssectors(_io, _parent, _root) {
    this._io = _io;
    this._parent = _parent;
    this._root = _root || this;
  ...
  Ssectors.prototype._read = function() {
    this.entries = [];
    var i = 0;
    while (!this._io.isEof()) {
      this.entries.push(new Ssector(this._io, this, this._root));
      i++;
    }
  }
  ...
  Object.defineProperty(IndexEntry.prototype, 'contents', {
    get: function() {
      ...
      case "SSECTORS":
        this._raw__m_contents = io.readBytes(this.size);
        var _io__raw__m_contents = new KaitaiStream(this._raw__m_contents);
        this._m_contents = new Ssectors(_io__raw__m_contents, this, this._root);
        break;
      case "SEGS":
        this._raw__m_contents = io.readBytes(this.size);
        var _io__raw__m_contents = new KaitaiStream(this._raw__m_contents);
        this._m_contents = new Segs(_io__raw__m_contents, this, this._root);
        break;
      case "VERTEXES":
        this._raw__m_contents = io.readBytes(this.size);
        var _io__raw__m_contents = new KaitaiStream(this._raw__m_contents);
      ...
      case "NODES":
        this._raw__m_contents = io.readBytes(this.size);
        var _io__raw__m_contents = new KaitaiStream(this._raw__m_contents);
        this._m_contents = new Nodes(_io__raw__m_contents, this, this._root);
        break;
      case "LINEDEFS":
        this._raw__m_contents = io.readBytes(this.size);
        var _io__raw__m_contents = new KaitaiStream(this._raw__m_contents);
...
var Node = DoomWad.Node = (function() {
  ...
  Node.prototype._read = function() {
    this.xStart = this._io.readS2le();
    this.yStart = this._io.readS2le();
    this.xChange = this._io.readS2le();
    this.yChange = this._io.readS2le();
    this.rightBounds = new Bounds(this._io, this, this._root);
    this.leftBounds = new Bounds(this._io, this, this._root);
    this.rightChild = this._io.readU2le();
    this.leftChild = this._io.readU2le();
  }

  return Node;
})();

var Ssector = DoomWad.Ssector = (function() {
  function Ssector(_io, _parent, _root) {
    this._io = _io;
    this._parent = _parent;
    this._root = _root || this;
  ...
  Ssector.prototype._read = function() {
    this.count = this._io.readS2le();
    this.firstSeg = this._io.readS2le();
  }

  return Ssector;
})();

var Segs = DoomWad.Segs = (function() {
  function Segs(_io, _parent, _root) {
    this._io = _io;
    this._parent = _parent;
    this._root = _root || this;
  ...
  Segs.prototype._read = function() {
    this.entries = [];
    var i = 0;
    while (!this._io.isEof()) {
      this.entries.push(new Seg(this._io, this, this._root));
      i++;
    }
  }
