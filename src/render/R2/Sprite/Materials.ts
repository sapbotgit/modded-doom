...
export function createShadowsSpriteMaterial(sprites: SpriteSheet, lightMap: DataTexture, lightLevels: DataTexture) {
    ...
    sampledDiffuseColor.rgb = vec3(0.0);
    sampledDiffuseColor.a = fract( time * noise(floor(vMapUv * 200.0)) );
    // I'm not sure I like how the shadows look from this but it's interesting at least
    // Maybe shadows just shouldn't cast shadows (they're already shadows, right?)
